            ...
            <table>
                ...
                >
                    ...
                    <td>
                        ...
                        <a
                            v-else
                            class="hover:underline text-green-600 target"
                            target="blank"
                        >
                            {{ market.url }}
                        </a>
...
import exchangeObj from '@/dummies/exchange'
...
export default {
        ...
        getWebSite(exchange) {
            return api
                ...
                .then((res) => {
                    ...
                    // Usar
                    console.log(res)
                    console.log('Exchange Object URL', exchangeObj.exchangeUrl)

                    this.$set(exchange, 'url', exchangeObj.exchangeUrl)
                    console.log('Exchange Modified: ', exchange)
                })
                .catch((e) => {
                    console.log('Error: ', e)
                    this.$set(exchange, 'url', exchangeObj.exchangeUrl)
  ...
  */
            Promise.all([
                ...
                .then(([asset, history, markets, exchanges]) => {
                ...
                .catch((e) => {
                    ...
                    this.exchange = exchangeObj.data
                })
